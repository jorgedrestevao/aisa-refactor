...
Estado: **decidido** — Q1–Q4 decididas pelo mantenedor (2026-09-24), todas na opção recomendada. Q5 (docs) decidida pelo mantenedor no início do F7.4 (2026-09-24), na opção recomendada.
...
| # | Decisão | Escolha (Q1–Q5 decididas) | Alternativa rejeitada |
| --- | --- | --- | --- |
