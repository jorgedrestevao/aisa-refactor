...
| | |
|---|---|
| registo | `_coverage/coverage_v14.json` |
...
- Há 10 achado(s) impeditivo(s) por resolver (COV-DEAD-REF, COV-REVIEW-INCOMPLETE).
...
| `COV-REVIEW-INCOMPLETE` | error | cov-012 | retirar ou alterar uma obrigação sem que a materialidade das unidades ligadas esteja declarada: desconhecer a materialidade não é o mesmo que saber que a unidade não é material (§4.4.1) | ligar as unidades e declarar a materialidade |
| `COV-DEAD-REF` | error | cov-012 | autoridade de âmbito que não resolve: shared-understanding.md#U-013 | — |
| `COV-REVIEW-INCOMPLETE` | error | cov-013 | retirar ou alterar uma obrigação sem que a materialidade das unidades ligadas esteja declarada: desconhecer a materialidade não é o mesmo que saber que a unidade não é material (§4.4.1) | ligar as unidades e declarar a materialidade |
| `COV-DEAD-REF` | error | cov-013 | autoridade de âmbito que não resolve: shared-understanding.md#U-004 | — |
...
| `COV-REVIEW-INCOMPLETE` | error | cov-026 | retirar ou alterar uma obrigação sem que a materialidade das unidades ligadas esteja declarada: desconhecer a materialidade não é o mesmo que saber que a unidade não é material (§4.4.1) | ligar as unidades e declarar a materialidade |
| `COV-DEAD-REF` | error | cov-026 | autoridade de âmbito que não resolve: shared-understanding.md#U-014 | — |
| `COV-DEAD-REF` | error | cov-026 | autoridade de âmbito que não resolve: council-log.md | — |
| `COV-REVIEW-INCOMPLETE` | error | cov-027 | retirar ou alterar uma obrigação sem que a materialidade das unidades ligadas esteja declarada: desconhecer a materialidade não é o mesmo que saber que a unidade não é material (§4.4.1) | ligar as unidades e declarar a materialidade |
| `COV-DEAD-REF` | error | cov-027 | autoridade de âmbito que não resolve: shared-understanding.md#U-014 | — |
