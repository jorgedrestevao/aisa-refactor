...
| | |
|---|---|
| registo | `_coverage/coverage_v11.json` |
| produzido em | 2026-09-24T13:48:39Z |
| alvo | — (reconciliação) |
| revisões anteriores | — |
...
| cov-026 | PM-U-007 | clarify | partial | 0 |
...
| cov-026 | PM-U-007 | partial | dispor PM-U-007 numa passagem futura (MAP/ADOPT/DISMISS) ou perguntar directamente ao dono | role: director de sistemas de informação |
...
| `COV-KNOWN-GAP` | warn | cov-026 | lacuna declarada (partial) sobre PM-U-007 | dispor PM-U-007 numa passagem futura (MAP/ADOPT/DISMISS) ou perguntar directamente ao dono |
