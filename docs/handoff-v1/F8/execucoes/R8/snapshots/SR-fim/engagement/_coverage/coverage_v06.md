...
| | |
|---|---|
| registo | `_coverage/coverage_v06.json` |
| produzido em | 2026-09-24T13:24:11Z |
...
- Há 6 achado(s) impeditivo(s) por resolver (COV-REVIEW-INCOMPLETE).
...
| `COV-REVIEW-INCOMPLETE` | error | b-cov-008 | retirar ou alterar uma obrigação sem que a materialidade das unidades ligadas esteja declarada: desconhecer a materialidade não é o mesmo que saber que a unidade não é material (§4.4.1) | ligar as unidades e declarar a materialidade |
| `COV-REVIEW-INCOMPLETE` | error | b-cov-009 | retirar ou alterar uma obrigação sem que a materialidade das unidades ligadas esteja declarada: desconhecer a materialidade não é o mesmo que saber que a unidade não é material (§4.4.1) | ligar as unidades e declarar a materialidade |
| `COV-REVIEW-INCOMPLETE` | error | b-cov-010 | retirar ou alterar uma obrigação sem que a materialidade das unidades ligadas esteja declarada: desconhecer a materialidade não é o mesmo que saber que a unidade não é material (§4.4.1) | ligar as unidades e declarar a materialidade |
...
| `COV-REVIEW-INCOMPLETE` | error | b-cov-016 | retirar ou alterar uma obrigação sem que a materialidade das unidades ligadas esteja declarada: desconhecer a materialidade não é o mesmo que saber que a unidade não é material (§4.4.1) | ligar as unidades e declarar a materialidade |
| `COV-REVIEW-INCOMPLETE` | error | b-cov-017 | retirar ou alterar uma obrigação sem que a materialidade das unidades ligadas esteja declarada: desconhecer a materialidade não é o mesmo que saber que a unidade não é material (§4.4.1) | ligar as unidades e declarar a materialidade |
...
| `COV-REVIEW-INCOMPLETE` | error | b-cov-023 | retirar ou alterar uma obrigação sem que a materialidade das unidades ligadas esteja declarada: desconhecer a materialidade não é o mesmo que saber que a unidade não é material (§4.4.1) | ligar as unidades e declarar a materialidade |
