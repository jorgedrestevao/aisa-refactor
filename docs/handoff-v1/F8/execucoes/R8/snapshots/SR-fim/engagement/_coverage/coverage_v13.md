...
| | |
|---|---|
| registo | `_coverage/coverage_v13.json` |
| produzido em | 2026-09-24T13:52:10Z |
| alvo | — (reconciliação) |
| revisões anteriores | — |
...
- Há 3 achado(s) impeditivo(s) por resolver (COV-DEAD-REF).
...
| cov-025 | C-003, A-006 | clarify | partial | 0 |
| cov-026 | PM-U-007 | retire | excluded | 0 |
| cov-027 | U-014 | clarify | partial | 0 |
...
| cov-027 | U-014 | partial | resposta do responsável de compras sobre o mecanismo exacto de suspensão | role: responsável de compras |
...
| `COV-KNOWN-GAP` | warn | cov-027 | lacuna declarada (partial) sobre U-014 | resposta do responsável de compras sobre o mecanismo exacto de suspensão |

## Quem reviu

- aisa (aisa-capture/aisa-answer, segmento SM F8 -- fonte nova pos-decisao) (agent), leitura da fonte nova (nota-urgentes.md) e do que mudou (C-003 -> A-006, PM-U-007) contra o inventario actual (coverage.py inventory), reutilizando o julgamento ja registado em coverage_v04.json para as unidades nao afectadas. Correccao nesta versao: PM-U-007 admitido como U-014 (nao era um id valido de requirement_ref); cov-026 retirado (excluded) em favor de cov-027.
