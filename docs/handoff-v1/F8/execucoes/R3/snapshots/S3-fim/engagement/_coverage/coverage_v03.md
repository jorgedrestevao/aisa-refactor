...
| | |
|---|---|
| registo | `_coverage/coverage_v03.json` |
| produzido em | 2026-09-24T13:12:22Z |
| alvo | — (reconciliação) |
| revisões anteriores | — |
...
|---|---|---|---|---|
| `COV-REVIEW-INCOMPLETE` | error | sr-capture-index | `materiality: 'not_applicable'` fora de material/not-material/undetermined (§4.3) | — |
| `COV-REVIEW-INCOMPLETE` | error | sr-pm-dismiss | `materiality: 'not_applicable'` fora de material/not-material/undetermined (§4.3) | — |
