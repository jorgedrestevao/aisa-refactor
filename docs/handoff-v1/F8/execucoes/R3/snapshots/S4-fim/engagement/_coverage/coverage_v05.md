...
| | |
|---|---|
| registo | `_coverage/coverage_v05.json` |
| produzido em | 2026-09-24T13:22:42Z |
...
| b-cov-008 | U-001 | clarify | partial | 0 |
| b-cov-009 | U-009 | clarify | partial | 0 |
| b-cov-010 | U-010 | clarify | partial | 0 |
...
| b-cov-008 | U-001 | partial | resposta do responsável de compras sobre volume mensal/semanal | role: responsável de compras |
| b-cov-009 | U-009 | partial | resposta de quem faz cada passo hoje, por passo | role: responsável de compras / role: requerente |
| b-cov-010 | U-010 | partial | resposta da direcção financeira/RH sobre a taxa carregada | role: direcção financeira |
...
| b-cov-016 | U-007 | partial | resposta da direcção financeira/director de SI sobre orçamento | role: direcção financeira / role: director de sistemas de informação |
| b-cov-017 | U-008 | partial | decisão do dono sobre o critério de sucesso | role: director de sistemas de informação |
...
| b-cov-019 | X-001 | partial | decisão do dono sobre a regra do caminho urgente face ao limiar financeiro (/answer X-001) | role: director de sistemas de informação |
...
| b-cov-023 | R-001, R-002 | partial | confirmar com o mantenedor do motor/skill; corrigir a escrita se for defeito | aisa (mantenedor do motor/skill, fora do papel do dono do processo) |
...
| `COV-KNOWN-GAP` | warn | b-cov-008 | lacuna declarada (partial) sobre U-001 | resposta do responsável de compras sobre volume mensal/semanal |
| `COV-KNOWN-GAP` | warn | b-cov-009 | lacuna declarada (partial) sobre U-009 | resposta de quem faz cada passo hoje, por passo |
| `COV-KNOWN-GAP` | warn | b-cov-010 | lacuna declarada (partial) sobre U-010 | resposta da direcção financeira/RH sobre a taxa carregada |
...
| `COV-KNOWN-GAP` | warn | b-cov-016 | lacuna declarada (partial) sobre U-007 | resposta da direcção financeira/director de SI sobre orçamento |
| `COV-KNOWN-GAP` | warn | b-cov-017 | lacuna declarada (partial) sobre U-008 | decisão do dono sobre o critério de sucesso |
...
| `COV-KNOWN-GAP` | warn | b-cov-019 | lacuna declarada (partial) sobre X-001 | decisão do dono sobre a regra do caminho urgente face ao limiar financeiro (/answer X-001) |
...
| `COV-KNOWN-GAP` | warn | b-cov-023 | lacuna declarada (partial) sobre R-001, R-002 | confirmar com o mantenedor do motor/skill; corrigir a escrita se for defeito |
