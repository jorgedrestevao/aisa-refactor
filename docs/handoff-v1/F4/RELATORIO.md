...
Estado: **completed** (2026-09-23). Gate T20–T24, render e publicação final cumprido e aceite pelo mantenedor, com os limites declarados da T21 e da T23 (§5). Desenho e decisões Q1–Q6: [DESENHO.md](DESENHO.md). F5 autorizada.
...
| F4.6 Percurso, relatório e gate | integrado | `564aaa3` | `test_hv1_design_path.py` 6 casos. `fx-hv1-02`: FC-0001 (submissão sem duplicar: jornada, dados, automação, recuperação, aceitação) autorizado com dados de teste e publicável; FC-0002 (valor) bloqueado pela regra de arredondamento em aberto (U-001), não autorizável, e devolvido ao autor funcional pelo render; rastreio requisito → FC → desenho. `fx-hv1-04`: FC-0010 headless (envio ao ERP-X sem duplicar, reagendamento, reprocessamento, escolha delegada com envelope, prova pendente) completo e autorizável sem nenhum ecrã. Full 96/96, 2898; stdlib 77/77, 2100; ambos exit 0. CI #50–#55 verdes |
