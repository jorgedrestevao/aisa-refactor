...
Regras desta página são normativas para `handoff-v1`. `classic` mantém o contrato legado enquanto não migrado. Nomes físicos de ficheiros novos são propostas a fixar em F1; campos e semântica não devem ficar implícitos em prompts.
