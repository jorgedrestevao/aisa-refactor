...
Versão do plano: 1.0 · Data: 2026-09-23 · Estado: especificação proposta, não implementada.
...
2. Introduzir o perfil experimental `handoff-v1`, mantendo `classic` como comportamento predefinido até cumprir os gates de adoção.
...
Esta entrega é um plano baseado em inspeção de código e contratos. Não executa a refatorização, não certifica a suite nem declara aprovado um piloto P8. Não contém preços/licenças atuais: a confirmação desses dados pertence ao engagement, com fonte e data.
