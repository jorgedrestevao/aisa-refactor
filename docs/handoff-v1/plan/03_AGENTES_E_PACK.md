...
Preservar os seis agentes de lentes no perfil classic. No perfil novo, reutilizar o seu conteúdo útil como checklists/mandatos do analista e especialistas. O `solution-architect` continua autor técnico; o chairman mantém síntese com regras de evidência corrigidas. Não apagar agentes antigos antes dos gates de rollout e de compatibilidade.
