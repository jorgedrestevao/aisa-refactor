...
| Relatório da fase F6 (**concluída; gate reaberto pela auditoria de 2026-09-24, corrigido e aceite de novo**; âmbito e inventário, rastreabilidade, gate de âmbito, release com índice, segredos, aceitação do destinatário) | [F6/RELATORIO.md](F6/RELATORIO.md) · [desenho](F6/DESENHO.md) · [ensaio T43](F6/T43-ENSAIO.md) |
| Relatório da fase F7 (**concluída; gate reaberto pela auditoria de 2026-09-24, corrigido e aceite de novo**; raio de impacto e stale derivado, versões suportadas, restore sem força, rollback, docs de operação) | [F7/RELATORIO.md](F7/RELATORIO.md) · [desenho](F7/DESENHO.md) |
...
| Fase corrente | **F8**, em `main` (F0–F8.1 e a correcção da auditoria entraram pelo PR #2, merge `188af41`, 2026-09-24): desenho decidido (Q1–Q5) e preparação dos pilotos (F8.1) integrados; gates da F6/F7 corrigidos ([F7/CORRECAO-AUDITORIA.md](F7/CORRECAO-AUDITORIA.md)) e aceites de novo (2026-09-24). **Próximo: F8.2 (primeiro piloto, fx-02) numa sessão nova** — retoma em [F8/RELATORIO.md](F8/RELATORIO.md) §6 |
