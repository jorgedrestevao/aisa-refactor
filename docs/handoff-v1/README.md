...
| Fase corrente | **F8**, na branch `claude/continua-com-o-plano-xaeq46` (tem F0–F8.1 e a correcção da auditoria; `main` não): desenho decidido (Q1–Q5) e preparação dos pilotos (F8.1) integrados; gates da F6/F7 corrigidos ([F7/CORRECAO-AUDITORIA.md](F7/CORRECAO-AUDITORIA.md)) e aceites de novo (2026-09-24). **Próximo: F8.2 (primeiro piloto, fx-02) numa sessão nova** — retoma em [F8/RELATORIO.md](F8/RELATORIO.md) §6 |
