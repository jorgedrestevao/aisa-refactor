...
| Relatório da fase F4 (**gate avaliado, aguarda aceitação**; contratos funcionais, autorização, coerência com o desenho, render) | [F4/RELATORIO.md](F4/RELATORIO.md) · [desenho](F4/DESENHO.md) |
| Fase corrente | **F4** — fecho por aceitar; F5 a seguir, depois da aceitação |
