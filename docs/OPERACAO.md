...
| Uma peça do desenho assenta numa premissa que mudou | `python library/kernel/tools/impact.py stale --engagement <slug>` | o autor da peça republica-a com a referência de agora; um contrato funcional volta a pedir autorização |
